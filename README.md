...
Any gold sent suffers the 30% tribute loss so no buying food with this excess amount, it would be the 30% loss of sending food directly as well as on top of the 5-30% loss of market tax through buying with this gold source i.e. better to create troops with, however any gold generated by player two now benifits from market ratio value and can be used to buy food if needed to reach optimal bank resource split.    
