...
Player (saracnes) primary focus is now on gold generation to buy food with, gold gen being much faster then food gen, but scarce on the map, player (saracens) now uses market ratio value to increase resulting food production when going up to castle by simply buying (saracens-poles) fuedal age food excess amount to reach optimal bank resource for max castle age troop creation. (Note, up to the limit of the fuedal age saracens-pole civ food bank of initial farm lay plus catle age time up * food gen rates.)
